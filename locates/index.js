...
i18n.translations = {
  pt: {
    ...
    index: {
      ...
      finalLista: "Isso é tudo por enquanto! 🎉",
    ...
    adicionar: {
      ...
      tituloVerso2: "Resposta ou Definição",
      exemploResposta: "Ex: Brasília",
    ...
    listaDeCategorias: {
      ...
      totalCategorias_plural: "{{count}} categorias",
      semResultados: "Nenhuma categoria encontrada",
      tenteOutroTermo: "Tente buscar com outro termo",
      nenhumaCategoria: "Nenhuma categoria criada",
      adicionarPrimeiraCategoria:
        "Crie sua primeira categoria para organizar seus cards",
    },
    resumo: {
      titulo: "Meu Progresso",
      semErrosTitulo: "Nenhum erro ainda! 🎉",
      semErrosSubtitulo: "Continue praticando para ver suas estatísticas aqui",
    ...
    configuracao: {
      ...
      lembreteTexto: "Receba notificações para estudar todos os dias",
      ...
      cancelar: "Cancelar",
      confirmar: "Confirmar",
      infoVersaoTitulo: "Sobre esta versão",
      versao: "Versão",
      ...
      alertaErro: "Não foi possível alterar as configurações",
      erroAbrirLink: "Não foi possível abrir o link",
      erroPolitica: "Erro ao abrir a política de privacidade",
      horarioDefinido: "Horário atualizado com sucesso",
      idiomaAlteradoTitle: "Idioma alterado",
      idiomaAlteradoTexto: "O app agora está em português",
      idioma: "Idioma",
      portugues: "Português",
      ingles: "English",
      tema: "Tema",
    ...
    estudo: {
      ...
      excelente: "Excelente! 🏆",
      bom: "Bom trabalho! 👍",
      precisaMelhorar: "Vamos praticar mais! 📚",
  ...
  en: {
    ...
    listaDeCategorias: {
      ...
      totalCategorias_plural: "{{count}} categories",
      semResultados: "No categories found",
      tenteOutroTermo: "Try searching with another term",
      nenhumaCategoria: "No categories created",
      adicionarPrimeiraCategoria:
        "Create your first category to organize your cards",
    },
    resumo: {
      titulo: "My Progress",
      semErrosTitulo: "No errors yet! 🎉",
    ...
    estudo: {
      ...
      excelente: "Excellent! 🏆",
      bom: "Good job! 👍",
      precisaMelhorar: "Let's practice more! 📚",
